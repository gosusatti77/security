...
import mlflow
import dagshub
dagshub.init(repo_owner='gosusatti77', repo_name='security', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model,classificationmetric):
        with mlflow.start_run():
            ...
            :param best_model: The best model to be tracked.
            :param classificationmetric: The classification metrics to be logged.
            """
    ...
    def train_model(self, X_train, y_train, X_test, y_test):
        ...
        #to get the best model based on the r2 score
        ...
        self.track_mlflow(
            best_model=best_model,classificationmetric=classification_test_metric
        )
